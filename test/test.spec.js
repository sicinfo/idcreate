...
test('newId - 1', t => {
  newId.call(undefined);
  t.assert(newId.call(undefined) && newId.call(undefined, date_now) === newid_result, 'OK');
  t.end();
});

test('newId - 2', t => {
  t.assert(newId.call(undefined, 0) === '0', 'OK');
  t.end();
});

test('newId - 3', t => {
  t.assert(newId.call(undefined, 1) === '1', 'OK');
  t.assert(newId.call(undefined, 1) !== '1', 'OK');
  t.end();
});

test('newId - 4', t => {
  t.assert(newId.call(undefined, 2) === '2', 'OK');
  t.end();
});
